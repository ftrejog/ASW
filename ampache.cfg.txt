...
; DEFAULT: ampache
database_name = "ampache_database"
...
secret_key = "42ddce23fa86496db178395fa2fa829e9e11c7774c7b24da17ee3383ac427a"
...
<head>
    ...
    <title>Ampache :: For the Love of Music - Installation</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <a class="navbar-brand" href="#">
                ...
                Ampache :: For the Love of Music - Installation            </a>
        </div>
    </div>
    <div class="container" role="main">
        <div class="jumbotron">
            <h1>Install Progress</h1>
            <div class="progress">
            ...
            <p>Step 1 - Create the Ampache database</p>
                <p><strong>Step 2 - Create configuration files (ampache.cfg.php ...)</strong></p>
                <dl>
                    <dd>This step takes the basic config values and generates the config file. If your config/ directory is writable, you can select "write" to have Ampache write the config file directly to the correct location. If you select "download" it will prompt you to download the config file, and you can then manually place the config file in /var/www/ampache.</dd>
                </dl>
            <ul class="list-unstyled">
                <li>Step 3 - Set up the initial account</li>
            </ul>
            </div>
            <p class="alert alert-danger">Configuration files were either not found or unreadable</p><form method="post" action="http://3.138.106.219/install.php?action=create_config" enctype="multipart/form-data" autocomplete="off">
            <h2>Generate Configuration File</h2>
            <h3>Various</h3>
<div class="form-group">
    <label for="web_path" class="col-sm-4 control-label">Web Path</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="web_path" name="web_path" value="">
            ...
            <div class="form-group">
    <label for="local_db" class="col-sm-4 control-label">Database Name</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="local_db" name="local_db" value="ampache_database">
    </div>
</div>
<div class="form-group">
    <label for="local_host" class="col-sm-4 control-label">MySQL Hostname</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="local_host" name="local_host" value="localhost">
    </div>
</div>
<div class="form-group">
    <label for="local_port" class="col-sm-4 control-label">MySQL Port (optional)</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="local_port" name="local_port" value=""/>
    </div>
</div>
<div class="form-group">
    <label for="local_username" class="col-sm-4 control-label">MySQL Username</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="local_username" name="local_username" value="database_user"/>
    </div>
</div>
<div class="form-group">
    <label for="local_pass" class="col-sm-4 control-label">MySQL Password</label>
    <div class="col-sm-8">
        <input type="password" class="form-control" id="local_pass" name="local_pass" value="database_password" placeholder="Password(required)">
    </div>
</div>

<input type="hidden" name="htmllang" value="en_US" />
<input type="hidden" name="charset" value="" />

<p>&nbsp;</p>
<h3>Installation Type</h3>
<div>Optimize Ampache for your use case. The installer will enable/disable features automatically.</div>
<br />
<div class="form-group">
    <div class="radio">
      <label><input type="radio" name="usecase" value="default" checked>Default &mdash; Ampache is configured for personal use with the best features.</label>
    </div>
    <div class="radio">
      <label><input type="radio" name="usecase" value="minimalist" >Minimalist &mdash; Only essential features are enabled to simply stream your music from the Web Interface.</label>
    </div>
    <div class="radio">
      <label><input type="radio" name="usecase" value="community" >Community &mdash; Recommended settings when using Ampache as a frontend for a music community.</label>
    </div>
</div>

<p>&nbsp;</p>
<h3>Allow Transcoding</h3>
<div>
    Transcoding allows you to convert music from one encoding to another. Ampache supports on the fly transcoding of any file type based on user, player, IP address or available bandwidth. In order to transcode, Ampache takes advantage of existing binary applications such as ffmpeg. In order for transcoding to work you must first install the supporting applications and ensure that they are executable by the web server.    <br />
    This section applies the default transcoding configuration according to the application you want to use. You may need to customize settings once setup has ended. <a href="https://github.com/ampache/ampache/wiki/Transcoding" target="_blank">See wiki page.</a>
</div>
<br />
<div class="form-group">
    <label for="transcode_template" class="col-sm-4 control-label">Template Configuration</label>
    <div class="col-sm-8">
...
<p>&nbsp;</p>
<h3>Players</h3>
<div>Ampache is more than only a web interface. Several backends are implemented to ensure you can stream your media to any player.</div>
<div>Select each backend to enable. Depending on the backend, you may need to perform additional configuration. <a href="https://github.com/ampache/ampache/wiki/API" target="_blank">See wiki page.</a></div>
<br />
<div class="form-group">
    ...
    <div class="checkbox-inline">
        <label><input type="checkbox" name="backends[]" value="subsonic" checked>Subsonic</label>
    </div>
    <div class="checkbox-inline">
        <label><input type="checkbox" name="backends[]" value="upnp" >UPnP</label>
    </div>
    <div class="checkbox-inline">
        <label><input type="checkbox" name="backends[]" value="daap" >DAAP (iTunes)</label>
    </div>
    <div class="checkbox-inline">
        <label><input type="checkbox" name="backends[]" value="webdav" >WebDAV</label>
    </div>
</div>
...
<div class="panel-group" id="accordion">
    <div id="config_files" class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><a data-toggle="collapse" data-target="#collapseConfigFiles" href="#collapseConfigFiles">File Insight</a></h3>
        </div>
        <div id="collapseConfigFiles" class="panel-collapse collapse in">
            <div class="panel-body">
                                    <div class="col-sm-4">&nbsp;</div><div class="col-sm-8">&nbsp;</div>
                    <div class="col-sm-4 control-label">
                        channel/.htaccess action                    </div>
                    <div class="col-sm-8">
                        <button type="submit" class="btn btn-warning" name="download_htaccess_channel">Download</button>
                        <button type="submit" class="btn btn-warning" name="write_htaccess_channel" disabled >
                            Write                        </button>
                    </div>
                    <div class="col-sm-4 control-label">channel/.htaccess exists?</div>
                    <div class="col-sm-8"><button type="button" class="btn btn-success">OK</span> <em></em></button></div>
                    <div class="col-sm-4 control-label">channel/.htaccess configured?</div>
                    <div class="col-sm-8"><button type="button" class="btn btn-success">OK</span> <em></em></button></div>

                    <div class="col-sm-4">&nbsp;</div><div class="col-sm-8">&nbsp;</div>
                    <div class="col-sm-4 control-label">
                        rest/.htaccess action                    </div>
                    <div class="col-sm-8">
                        <button type="submit" class="btn btn-warning" name="download_htaccess_rest">Download</button>
                        <button type="submit" class="btn btn-warning" name="write_htaccess_rest" disabled >
                            Write                        </button>
                    </div>
                    <div class="col-sm-4 control-label">rest/.htaccess exists?</div>
                    <div class="col-sm-8"><button type="button" class="btn btn-success">OK</span> <em></em></button></div>
                    <div class="col-sm-4 control-label">rest/.htaccess configured?</div>
                    <div class="col-sm-8"><button type="button" class="btn btn-success">OK</span> <em></em></button></div>

                    <div class="col-sm-4">&nbsp;</div><div class="col-sm-8">&nbsp;</div>
                    <div class="col-sm-4 control-label">
                        play/.htaccess action                    </div>
                    <div class="col-sm-8">
                        <button type="submit" class="btn btn-warning" name="download_htaccess_play">Download</button>
                        <button type="submit" class="btn btn-warning" name="write_htaccess_play" disabled >
                            Write                        </button>
                    </div>
                    <div class="col-sm-4 control-label">play/.htaccess exists?</div>
                    <div class="col-sm-8"><button type="button" class="btn btn-success">OK</span> <em></em></button></div>
                    <div class="col-sm-4 control-label">play/.htaccess configured?</div>
                    <div class="col-sm-8"><button type="button" class="btn btn-success">OK</span> <em></em></button></div>
                
                <div class="col-sm-4">&nbsp;</div><div class="col-sm-8">&nbsp;</div>
                <div class="col-sm-4">
                    config/ampache.cfg.php action                </div>
                <div class="col-sm-8">
                    <button type="submit" class="btn btn-warning" name="download">Download</button>
                    <button type="submit" class="btn btn-warning" name="write" >
                        Write                    </button>
                </div>
                <div class="col-sm-4 control-label">config/ampache.cfg.php exists?</div>
                <div class="col-sm-8"><button type="button" class="btn btn-danger">Error</span> <em></em></button></div>
                <div class="col-sm-4 control-label">config/ampache.cfg.php configured?</div>
                <div class="col-sm-8"><button type="button" class="btn btn-danger">Error</span> <em></em></button></div>
                <div class="col-sm-4">&nbsp;</div><div class="col-sm-8">&nbsp;</div>

                <div class="col-sm-4"></div>
                                <div class="col-sm-8">
                    <a href="http://3.138.106.219/install.php?action=show_create_config&htmllang=en_US&charset=&local_db=ampache_database&local_host=localhost">[Recheck Config]</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-sm-4">
    <button type="submit" class="btn btn-warning" name="skip_config">Skip</button>
</div>
<div class="col-sm-8">
    <button type="submit" class="btn btn-warning" name="create_all">Create Config</button>
</div>
</form>
    ...
    ================================================== -->
    <script src="http://3.138.106.219/lib/components/jquery/jquery.min.js"></script>
    <script src="http://3.138.106.219/lib/components/bootstrap/js/bootstrap.min.js"></script>
    <script src="http://3.138.106.219/lib/javascript/base.js"></script>
        </body>
</html>
